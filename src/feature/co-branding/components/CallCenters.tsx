...
export default function CallCenters() {
  return (
    <section
      ...
      className="relative text-white my-16 pt-8 lg:mt-32"
    >
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-12 lg:gap-20 ">
          ...
          <div className="relative z-20 pt-10 lg:pt-0 text-center md:text-left">
            <div className="mt-4 lg:mt-32 ">
              ...
              <p className="point-heading mb-8!">
          ...
          <div className="relative z-10 pt-0 lg:pt-32">
            <div className="flex flex-col space-y-12 section-subtitle ">
              <p>
            ...
            <div className="mt-16 max-w-[330px]">
              <Asterisk
                size={32}
            ...
            <div className="hidden md:block absolute -top-34 right-0 w-[400px]">
