...
export default function ExistenceBanner() {
  const { lg, md } = Grid.useBreakpoint();
  return (
    <section className="px-2  lg:mb-16">
      <section
        style={{
          backgroundImage:
            "url('/assets/bg/existence/existence-banner-bg.png')",
      ...
      >
        <div className="container grid grid-cols-1 md:grid-cols-2 pt-26 md:pt-48 pb-28 ">
          ...
          <div className="pl-6 2xl:pl-0 relative col-span-2">
            {/* Glowing Tag */}
            <GlowingTag text="Why we exist" />

            <h1 className="page-title my-8 relative z-10  lg:max-w-[890px] md:font-semibold!">
              Call centers deserve a real engineering partner
            </h1>
            <p className="section-subtitle max-w-[600px] relative z-10">
              Not another tool. Not another platform. A team that builds,
              integrates, and owns the solution.
              <Image
            ...
            {/* Top Left SVG Line */}
            <svg
              className="absolute -left-[607%] lg:-left-[605%]  xl:-left-[633%] 2xl:-left-[628%] h-[274px] top-10 lg:h-[400px] lg:-top-[10px]  xl:-top-[70px] 2xl:-top-[60px] z-0  pointer-events-none xl:scale-150 hidden md:block"
